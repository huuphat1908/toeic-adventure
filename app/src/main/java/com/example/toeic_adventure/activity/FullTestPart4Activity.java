...
public class FullTestPart4Activity extends AppCompatActivity {
    JSONArray questions;
    JSONObject question;
    JSONObject answer;
    int index = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_test_part4);
    ...
    private void onSubmit() {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(FullTestPart4Activity.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    ...
    private void initView() {
        ...
        tvTranscript.setBackground(ContextCompat.getDrawable(FullTestPart4Activity.this, R.drawable.sharp_cardview_bg));
    ...
    private void prepareMediaPlayer() {
        try {
            ...
            Toast.makeText(FullTestPart4Activity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
