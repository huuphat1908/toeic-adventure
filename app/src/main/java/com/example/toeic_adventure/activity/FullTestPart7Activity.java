...
public class FullTestPart7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_test_part7);
    ...
    private void onSubmit() {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(FullTestPart7Activity.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    ...
    private void initView() {
        ...
        tvTranscript.setBackground(ContextCompat.getDrawable(FullTestPart7Activity.this, R.drawable.sharp_cardview_bg));
